...
public partial class SettingsPanel : Control
{
    ...
    private readonly string[] _categories = { "AI模型", "群聊", "猜测", "整合", "信息", "帮助", "通用" };
    ...
    private void OnSearchChanged(string newText)
    {
        ...
        {
            var visible = string.IsNullOrEmpty(newText) ||
    ...
    private async System.Threading.Tasks.Task<bool> TestModelConnection(AiModelConfig model)
    {
        try
        {
            Core.Ai.IAiService service = model.ApiFormat == "Anthropic"
    ...
    private void BuildChatConfig()
    {
        ...
        filterOption.Select(_settings.MessageFilterMode switch
        {
            "ai" => 1,
            "strict_then_ai" => 2,
            _ => 0
